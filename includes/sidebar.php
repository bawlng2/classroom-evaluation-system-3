...
<nav class="sidebar">
    ...
    <ul class="sidebar-nav">
        <?php if($_SESSION['role'] == 'edp'): ?>
            ...
            <li><a href="../edp/dashboard.php" class="nav-link"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        ...
        <?php elseif(in_array($_SESSION['role'], ['dean', 'principal', 'chairperson', 'subject_coordinator'])): ?>
            <li><a href="../evaluators/dashboard.php" class="nav-link"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
